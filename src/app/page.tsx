  ...
  return (
    <div className="bg-background min-h-screen pb-20 md:pb-0">
      <div className="max-w-md mx-auto px-4 md:hidden">
        ...
        {/* Hero */}
        <div className="bg-gradient-to-br from-primary to-[#1a5a9a] rounded-2xl p-6 text-white mb-5 overflow-hidden">
...
function MobileFooter() {
  return (
    <footer className="border-t border-[#E0E0E0] pt-6 pb-4">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-6">
        <Link href="/kiosks" className="flex items-center gap-2 text-text-secondary text-sm hover:text-primary transition-colors">
          <MapPin size={16} />
          Vendor Map
        </Link>
        ...
        <Link href="/vendor" className="flex items-center gap-2 text-text-secondary text-sm hover:text-primary transition-colors">
          <LogIn size={16} />
          Vendor Login
        </Link>
      </div>
      ...
      <div className="flex flex-col gap-2 mb-6">
        ...
        <a href="https://wa.me/254758434076" className="flex items-center gap-2 text-text-secondary text-sm hover:text-primary transition-colors">
          <Phone size={14} />
          +254 758 434 076
        </a>
          ...
          <div className="grid grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link href="/track" className="text-white/60 text-sm hover:text-white transition-colors">Track Order</Link>
              </div>
            </div>
            <div>
              <h4 className="font-bold text-sm mb-4 uppercase tracking-wide text-white/80">Company</h4>
              <div className="flex flex-col gap-2">
                <Link href="/kiosks" className="text-white/60 text-sm hover:text-white transition-colors">Vendor Map</Link>
                <Link href="/impact" className="text-white/60 text-sm hover:text-white transition-colors">About MiMaji</Link>
                <Link href="/rewards" className="text-white/60 text-sm hover:text-white transition-colors">Rewards</Link>
                <Link href="/contact" className="text-white/60 text-sm hover:text-white transition-colors">Contact Us</Link>
                <Link href="/vendor" className="text-white/60 text-sm hover:text-white transition-colors">Vendor Login</Link>
              </div>
            </div>
            <div>
              <h4 className="font-bold text-sm mb-4 uppercase tracking-wide text-white/80">Contact Us</h4>
              <div className="flex flex-col gap-2">
                <a href="https://wa.me/254758434076" className="text-white/60 text-sm hover:text-white transition-colors flex items-center gap-2">
                  <Phone size={14} />
                  +254 758 434 076
                </a>
