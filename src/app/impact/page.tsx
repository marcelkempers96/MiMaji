...
const stats = [
  { value: "50,500", label: "Litres donated", icon: "💧" },
  { value: "3,900", label: "Families reached", icon: "👨‍👩‍👧‍👦" },
  { value: "8", label: "Counties served", icon: "🗺" },
  { value: "15", label: "Partner organisations", icon: "🤝" },
];
...
export default function ImpactPage() {
  return (
    <div className="min-h-screen bg-white font-body">
      ...
      {/* Hero */}
      <div className="bg-blue-900 px-5 pt-8 pb-10">
      ...
      {/* Pledge */}
      <div className="-mt-5 mx-4 bg-white rounded-2xl p-5 shadow-md border border-blue-200 relative z-10 mb-6">
      ...
      <div className="px-4 mb-8">
        ...
        <div className="space-y-4">
          {stories.map((story) => (
            <div
              key={story.title}
              className="bg-white rounded-2xl p-5 border border-blue-200 shadow-sm"
            >
      ...
      {/* How you help */}
      <div className="mx-4 mb-8 bg-blue-50 rounded-2xl p-5">
        <h2 className="font-bold text-blue-900 text-lg mb-3">
          How your order helps
        </h2>
        <div className="space-y-3">
          {[
            { qty: "5 jugs (100L)", donation: "5 litres donated", icon: "💧" },
            { qty: "10 jugs (200L)", donation: "10 litres donated", icon: "💧💧" },
            { qty: "50 jugs (1,000L)", donation: "50 litres donated", icon: "🌊" },
          ].map((tier) => (
            <div
              key={tier.qty}
              className="bg-white rounded-xl p-3 flex items-center justify-between border border-blue-200"
            >
              <div>
      ...
      {/* Partner CTA */}
      <div className="mx-4 mb-8 bg-blue-900 rounded-2xl p-6 text-center">
