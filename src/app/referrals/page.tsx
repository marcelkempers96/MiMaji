        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              desc: "They use your code when signing up",
            },
            {
              step: "3",
              title: "You BOTH get 10 litres free",
              desc: "That's half a 20L jug each!",
            },
          ].map((s) => (
        ...
        <div className="bg-white rounded-2xl p-5 border border-blue-200 shadow-sm">
          ...
          <div className="mt-4 space-y-2">
            {referrals.map((ref, i) => (
              <div
                key={i}
                className="flex items-center justify-between p-2.5 bg-blue-50 rounded-xl text-sm"
              >
