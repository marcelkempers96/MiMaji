...
const sections = [
  ...
  { title: "10. Limitation of Liability", body: "To the fullest extent allowed by the laws of Kenya, MiMaji, its directors, employees, and affiliates shall not be liable for any indirect, incidental, consequential, or punitive damages arising from or related to your use of the Platform, including but not limited to loss of profits, data, business opportunity, or goodwill. Our total aggregate liability for any claim shall not exceed the total fees you paid to MiMaji in the twelve (12) months preceding the claim." },
  { title: "11. Indemnification", body: "You agree to indemnify and hold harmless MiMaji and its officers, directors, employees, and agents from any claims, damages, losses, costs, or expenses (including reasonable legal fees) arising from your breach of these Terms, your use of the Platform, or your violation of any third-party right." },
  ...
  const content = (
    <>
      <div className="bg-surface shadow-card rounded-xl p-5 mb-4">
        ...
        <p className="text-text-secondary text-xs">Governing law: Republic of Kenya</p>
        <p className="text-text-secondary text-sm mt-3 leading-relaxed">
          Welcome to MiMaji (&quot;mimaji.co.ke&quot;). The MiMaji platform and mobile application (&quot;Platform&quot;) are owned and operated by MiMaji (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;). By using our Platform, you confirm that you have read, understood, and accepted these Terms of Use (&quot;Terms&quot;). If you do not agree, please discontinue use immediately.
        </p>
      </div>
