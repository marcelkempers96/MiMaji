  ...
  const content = (
    <>
      <div className="bg-surface shadow-card rounded-xl p-5 mb-4">
        ...
        <p className="text-text-secondary text-xs">Data controller: MiMaji, Nairobi, Kenya</p>
        <p className="text-text-secondary text-sm mt-3 leading-relaxed">
          MiMaji (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) operates the MiMaji platform at mimaji.co.ke and through the MiMaji mobile application. We take the security and confidentiality of your personal data seriously. This Privacy Policy describes what information we gather, the purposes for which we use it, with whom we share it, and the choices available to you.
        </p>
      </div>
